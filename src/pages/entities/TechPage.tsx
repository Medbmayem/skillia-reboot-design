    ...
    <div className="min-h-screen">
      ...
      <main>
        ...
        <section className="h-[45vh] md:h-[60vh]">
          <img src="https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&w=2000&q=80" alt="Environnement de travail moderne" className="w-full h-full object-cover" />
        </section>
