...
const services = [
  ...
  },
  {
    ...
    description: "Migration et optimisation des infrastructures cloud, déploiement d'architectures sécurisées et évolutives.",
    icon: (
      <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "Exploitation des données pour générer des insights commerciaux, tableaux de bord interactifs et KPIs personnalisés.",
    icon: (
      <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "Programmes de formation sur mesure pour vos équipes en IA, cybersécurité et transformation numérique.",
    icon: (
      <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
