  ...
  const services = [
    {
      ...
      icon: (
        <div className="p-3 bg-blue-100 rounded-lg text-skillia-blue">
    ...
    },
    {
      ...
      icon: (
        <div className="p-3 bg-rose-100 rounded-lg text-[#FA2A88]">
          <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      icon: (
        <div className="p-3 bg-purple-100 rounded-lg text-[#403AF2]">
          <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
