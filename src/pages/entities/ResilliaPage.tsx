      ...
      <main>
        <section className="relative min-h-[75vh] flex items-end pb-20">
          <div className="absolute inset-0 z-0">
            <img src="https://images.unsplash.com/photo-1448630360428-65456885c650?auto=format&fit=crop&w=2000&q=80" alt="Architecture contemporaine — solidité et résilience" className="w-full h-full object-cover" />
        ...
        <section className="h-[45vh] md:h-[60vh]">
          <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=2000&q=80" alt="Tour de bureaux — solidité architecturale" className="w-full h-full object-cover" />
        </section>
