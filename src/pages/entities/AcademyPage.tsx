      ...
      <main>
        <section className="relative min-h-[75vh] flex items-end pb-20">
          <div className="absolute inset-0 z-0">
            <img src={heroImage} alt="Échange professionnel — formation et accompagnement" className="w-full h-full object-cover" />
        ...
        <section className="py-32 md:py-44 section-navy">
          <div className="container">
            <div className="max-w-2xl">
              ...
              <a href="https://www.skillia-academy.com" target="_blank" rel="noopener noreferrer" className="block mt-6 text-sm font-sans text-background/30 border-b border-background/10 pb-0.5 hover:text-background/60 hover:border-background/30 transition-colors w-fit">skillia-academy.com ↗</a>
            </div>
          </div>
        </section>
      </main>
