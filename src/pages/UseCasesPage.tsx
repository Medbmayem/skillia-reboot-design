      ...
      <main>
        ...
        <section className="relative min-h-[65vh] flex items-end pb-20">
          <div className="absolute inset-0 z-0">
            <img src="https://images.unsplash.com/photo-1557682250-33bd709cbe85?auto=format&fit=crop&w=2000&q=80" alt="Gradient abstrait — cadrage stratégique" className="w-full h-full object-cover" />
