      ...
      <main>
        <section className="relative min-h-[55vh] flex items-end pb-20">
          <div className="absolute inset-0 z-0">
            <img src="https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=2000&q=80" alt="Espace vitré — calme et échange" className="w-full h-full object-cover" />
